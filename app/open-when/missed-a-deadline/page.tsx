    ...
    <>
      <JsonLd
        data={{
          ...
          "@type": "Article",
          headline: "Open When You Missed a Deadline",
          description: "Missing a deadline is an event. It is not a personality.",
          url: "https://adhddiaryproject.com/open-when/missed-a-deadline",
          mainEntityOfPage: "https://adhddiaryproject.com/open-when/missed-a-deadline",
          publisher: {
            "@type": "Organization",
      ...
      <JsonLd
        data={{
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Missed a Deadline", item: "https://adhddiaryproject.com/open-when/missed-a-deadline" },
          ],
        }}
      />
